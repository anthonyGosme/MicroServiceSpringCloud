...
public class ProductCompositeServiceApplication {
  ...
  public Docket apiDocumentation() {
    ...
    return new Docket(SWAGGER_2)
        ...
        .apis(
            basePackage(
                "com.agosme.microservices.composite")) // where to look for add documentation
        .paths(PathSelectors.any()) // where to look for add documentation
        .build()
        .globalResponseMessage(GET, emptyList()) // no default code  to the documetation (401, 403
        .apiInfo(
            new ApiInfo(
                apiTitle,
                apiDescription,
